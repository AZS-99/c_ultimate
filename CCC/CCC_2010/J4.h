...
number of temperatures in a sequence, followed by the sequence of n temperatures. You may assume that each temperature
...
4 3 4 6 7
2
11 1 10 13 45 48 57 60 92 95 104 107
4
...
class Pattern{
    std::unordered_map<int, unsigned> distances;
    std::vector<int> diff;
public:
    Pattern();
};
