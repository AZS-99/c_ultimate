...
She records each of these measurements in a table, with one col for each plant, with the first col recording the
shortest sunflower’s growth and the last col recording the tallest sunflower’s growth. The leftmost column is the first
